...
class Features13 extends Component {
  render() {
  ...
  <div className="container">
    <div className="row text-lg-right align-items-center">
      <div className="col-12 col-sm-6 col-lg-3">
        ...
        <img alt="layers" className="fdb-icon mt-3 mt-xl-5" src="./imgs/icons/layers.svg" />
        <h4><strong>Feature Two</strong></h4>
        <p>On her way she met a copy of the Little Blind Text.</p>

        <img alt="map" className="fdb-icon mt-3 mt-xl-5" src="./imgs/icons/map.svg" />
      ...
      <div className="col-12 col-sm-6 col-lg-3 text-left pt-3 pt-sm-0 order-lg-12">
        ...
        <img alt="package" className="fdb-icon mt-3 mt-xl-5" src="./imgs/icons/package.svg" />
        <h4><strong>Feature Five</strong></h4>
        <p>Separated they live in Bookmark right at the coast</p>

        <img alt="monitor" className="fdb-icon mt-3 mt-xl-5" src="./imgs/icons/monitor.svg" />
