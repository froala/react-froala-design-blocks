  ...
  <div className="container">
    ...
    <div className="row text-left align-items-center pt-5 pb-md-5">
      ...
      <div className="col-12 col-md-5 m-md-auto">
        ...
        <p><a href="https://www.froala.com">Learn More <i className="fas fa-angle-right"></i></a></p>
      </div>
    </div>
    ...
    <div className="row text-left align-items-center pt-5 pb-md-5">
      ...
      <div className="col-12 col-md-5">
        ...
        <p className="h3">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
        <p><a href="https://www.froala.com">Learn More <i className="fas fa-angle-right"></i></a></p>
      </div>
    </div>
    ...
    <div className="row text-left align-items-center pt-5">
      ...
      <div className="col-12 col-md-5 m-md-auto">
        ...
        <p className="h3">On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn
          around.</p>
        <p><a href="https://www.froala.com">Learn More <i className="fas fa-angle-right"></i></a></p>
      </div>
    </div>
