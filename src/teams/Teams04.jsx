...
class Teams04 extends Component {
  render() {
    return <section className="fdb-block team-4">
  <div className="container">
    ...
    <div className="row text-center mt-5">
      <div className="col-3">
        <img alt="image" className="img-fluid rounded" src="./imgs/people/5.jpg" />
