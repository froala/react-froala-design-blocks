...
class Pricings05 extends Component {
  render() {
    return <section className="fdb-block bg-dark" style={{backgroundImage: 'imgs/bg_1.svg'}}>
  <div className="container">
    ...
    <div className="row mt-5 align-items-center no-gutters">
      <div className="col-12 col-sm-10 col-md-8 m-auto col-lg-4 text-center">
        <div className="bg-gray pb-5 pt-5 pl-4 pr-4">
          ...
          <p className="text-center pt-4"><a href="https://www.froala.com" className="btn btn-primary btn-white btn-shadow">Choose Plan</a></p>
        </div>
      </div>

      <div className="col-12 col-sm-10 col-md-8 ml-auto mr-auto col-lg-4 text-center mt-4 mt-lg-0 sl-1 pt-0 pt-lg-3 pb-0 pb-lg-3 bg-gray fdb-touch">
      ...
      <div className="col-12 col-sm-10 col-md-8 ml-auto mr-auto col-lg-4 text-center mt-4 mt-lg-0">
        <div className="bg-gray pb-5 pt-5 pl-4 pr-4">
